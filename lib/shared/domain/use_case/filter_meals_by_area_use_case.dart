...
class FilterMealsByAreaUseCase extends BaseFutureUseCase<List<MealEntity>, String> {
  final BaseMealsRepository _mealsRepository;

  FilterMealsByAreaUseCase(this._mealsRepository);

  @override
  Future<Either<Failure, List<MealEntity>>> call(String parameters) async
  => await _mealsRepository.filterMealsByArea(parameters);
