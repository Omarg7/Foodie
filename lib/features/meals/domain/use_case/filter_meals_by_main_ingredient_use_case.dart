...
class FilterMealsByIngredientUseCase extends BaseFutureUseCase<List<MealEntity>, String> {
  final BaseMealsRepository _mealsRepository;

  FilterMealsByIngredientUseCase(this._mealsRepository);

  @override
  Future<Either<Failure, List<MealEntity>>> call(String parameters) async
  => await _mealsRepository.filterMealsByIngredient(parameters);
